    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span>203 Hanuman Mandir Patel Nagar, Delhi, India</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://1234567920">+ +91 9849 6258 20</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:info@NaukariAdda.com">info@NaukariAdda.com</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website</span> <a href="#">NaukariAdda.com</a></p>
          </div>
        </div>
