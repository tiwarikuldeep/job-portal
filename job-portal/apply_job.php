...
if (isset($_POST['submit'])) {
    ...
    if(mysqli_num_rows($sql)>0){
     ...
     $query=mysqli_query($conn , " insert into job_apply (first_name, last_name,dob,file,id_job,job_seeker, mobile_no)values('$first_name','$last_name','$dob','$file','$id_job','$job_seeker','$number')");
