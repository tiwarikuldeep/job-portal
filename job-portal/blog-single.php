...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.php">Naukari Adda</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item cta cta-colored"><a href="logout1.php" class="nav-link">Logout</a></li>
            <?php 
            }else{ ?>
...
$id=$_GET['id'];
$query=mysqli_query($conn , "select * from all_job where job_id='$id'");
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5" data-scrollax=" properties: { translateY: '70%' }">
          	<p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-3"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-3"><a href="blog.html">Job <i class="ion-ios-arrow-forward"></i></a></span> <span>Job Apply</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">JOb APPLY</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-8 ftco-animate">
           ...
           <input type="hidden" name="id_job" value="<?php echo $id_job; ?>" id="id_job">
            ...
            <input type="text" class="form-control disabled" value="<?php echo $_SESSION['email']; ?>" disabled>
            </div>
            </div>
